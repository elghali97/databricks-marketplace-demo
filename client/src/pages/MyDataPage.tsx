...
const MyDataPage = () => {
  ...
  // State for access requests with ability to update - MOVED TO TOP
  ...
  const ownedDatasets = datasets.filter((dataset) => 
  ...
  const accessedDatasets = datasets.filter((dataset) => 
    dataset.provider.name !== user?.organization && 
          ...
          <div className="flex items-center justify-center h-64">
            <div className="text-center">
              <div className="bg-red-100 text-red-700 p-4 rounded-xl border border-red-200 max-w-md">
                <p className="font-medium mb-2" style={{ fontFamily: 'DM Sans, system-ui, sans-serif' }}>
                  Failed to load datasets
                </p>
                <p className="text-sm text-red-600" style={{ fontFamily: 'DM Sans, system-ui, sans-serif' }}>
                  {error}
                </p>
              </div>
            </div>
